...
namespace AileronAirwaysWeb.ViewModels
{
    ...
    public class TimelineEventLocationViewModel
    {
        [Required]    
        public string Location { get; set; }
        [RegularExpression(@"^(\+|-)?(?:85(?:(?:\.0{1,15})?)|(?:[0-9]|[1-8][0-5])(?:(?:\.[0-9]{1,15})?))$", ErrorMessage = "No details available for this latitude input:valid input is more than -85 and less than 85, data you input does not save")]
